...
region <- regions[2,]
plot(st_geometry(st_crop(Protected_areas, region)), col = "#2ca25f", 
     border = 'grey', axes = TRUE)
plot(st_geometry(region), lty = 1, lwd = 2, add = T)
```
...
library(classInt)
diic <- tm_shape(test_protconn$ProtConn_Delta) + tm_fill("dProtConn", palette = RColorBrewer::brewer.pal(5, "RdYlGn"),                                breaks =  c(-0.0000194471, 0, 3.2060153958, 5.8717852689, 9.1473400540, 23.4648579636))+ 

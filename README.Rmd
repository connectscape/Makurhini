...
tmap_mode("plot")
c <- 9
dPC <- tm_shape(PC_example_2$d10000) + tm_fill("dPC", 
                                               fill.scale = tm_scale(breaks =  classIntervals(PC_example_2$d10000$dPC, c, "jenks")[[2]],
...
dintra <- tm_shape(PC_example_2$d10000) + tm_fill("dPCintra", 
                                                  fill.scale = tm_scale(values = RColorBrewer::brewer.pal(c, "RdYlGn"), 
                                                                        breaks =  classIntervals(PC_example_2$d10000$dPCintra, c, "jenks")[[2]]))+ 
  tm_shape(TMVS) + tm_borders(lwd = 1.5)+ tm_layout(legend.width = 4.3, 
                                                    legend.height = 5.6,
                                                    legend.position = c(-0.01, 0.3),
                                                    legend.text.size = 1,
...
dflux <- tm_shape(PC_example_2$d10000) + tm_fill("dPCflux",
                                                 fill.scale = tm_scale(values = RColorBrewer::brewer.pal(c, "RdYlGn"), 
                                                                       breaks =  classIntervals(PC_example_2$d10000$dPCflux, c, "jenks")[[2]]))+
  tm_shape(TMVS) + tm_borders(lwd = 1.5)+ tm_layout(legend.width = 4.3, 
                                                    legend.height = 5.6,
                                                    legend.position = c(-0.01, 0.3),
                                                    legend.text.size = 1,
...
dconect <- tm_shape(PC_example_2$d10000) + tm_fill("dPCconnector", 
                                                   fill.scale = tm_scale(values = RColorBrewer::brewer.pal(c, "RdYlGn"), 
                                                                         breaks =  classIntervals(PC_example_2$d10000$dPCconnector, c, "jenks")[[2]]))+ 
  tm_shape(TMVS) + tm_borders(lwd = 1.5)+ tm_layout(legend.width = 4.3, 
                                                    legend.height = 5.6,
                                                    legend.position = c(-0.01, 0.3),
                                                    legend.text.size = 1,

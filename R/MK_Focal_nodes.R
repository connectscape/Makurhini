...
#' @param area_unit \code{character}. (\emph{optional, default = } \code{"ha"}). A \code{character} indicating the area units when \code{attribute} is \code{NULL}. Some options are "m2", "km2", "cm2", or "ha" (the default);  See \link[Makurhini]{unit_convert} for details.

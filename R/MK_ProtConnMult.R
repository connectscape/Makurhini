...
#' @param regions object of class \code{sf, sfc, sfg,  SpatVector, spatialPolygonsDataFrame}. Polygon delimiting the \bold{regions} or \bold{study areas}. It must be in a projected coordinate system.
